...
document.querySelector("#question_container").style.display = "none";  // useless now, like the one below  - same if el is hidden here...
// button.innerHTML = button_text;

// all progress happens through this buttn click
